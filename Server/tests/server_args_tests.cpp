...
TEST(server_args_tests, test_less_args)
{
	int argc1 = 0;
    int argc2 = 1;
    int argc3 = 2;
...
TEST(server_args_tests, test_non_digit_input)
{
    int argc = 3;
...
TEST(server_args_tests, test_ivalid_port_range)
{
    int argc = 3;
...
TEST(server_args_tests, test_correct_data)
{
    int argc = 3;
